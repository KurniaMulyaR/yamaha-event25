...
>
    ...
    <button
        ...
        class="w-14 h-24 bg-gradient-to-b from-black to-red-900/60 rounded-l-xl flex items-center justify-center text-white text-2xl shadow-lg"
    >
        ‹
    </button>
    ...
    <button
        ...
        class="w-14 h-24 bg-gradient-to-b from-black to-red-900/60 rounded-r-xl flex items-center justify-center text-white text-2xl shadow-lg"
    >
        ›
    </button>
